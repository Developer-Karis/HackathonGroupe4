        ...
        <div class="left">
            <div class="top">
                <div class="row">
                    ...
                    <img src="https://www.flaticon.com/svg/static/icons/svg/3135/3135715.svg" style="height: 30px" alt="">
                    <h5 class="font-weight-bold ml-2" >{{Auth::user()->name}}</h5>
                </div>
            ...
            <ul class="people">
                ...
                <form action="/contact/{{Auth::user()->id}}" method="post">
                    @csrf
                    <h6>Ils maitrisent la matière dont vous avez besoin :</h6>

                    @foreach ($user as $item)

                    @if (Auth::user()->Html_css=="non" && $item->Html_css=="oui" || Auth::user()->Javascript=="non" && $item->Javascript=="oui" || Auth::user()->React_JS=="non" && $item->React_JS=="oui" || Auth::user()->Laravel=="non" && $item->Laravel=="oui")
